...
<div class="container ">
    <div class="row justify-content-center my-4">
        <div class="col-8">
            <a href="{{ route('book') }}"  class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i> Back</a>
            <div class="card-header text-center">Form Create Book</div>
            ...
            <form action="{{ route('book.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" id="cover_image" name="cover_image" class="form-control  mt-2 @error('cover_image') is-invalid @enderror" aria-label="6" file example  onchange="previewImage()"> 
                ...
                <div class="mb-3">
                    ...
                    <input type="file" id="pdf_file" name="pdf_file" class="form-control mt-2 @error('pdf_file') is-invalid @enderror" aria-label="Upload PDF" accept=".pdf" onchange="previewPDF()"> 
                    <div class="invalid-feedback">
                        @error('pdf_file')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="Enter author" id="author-val" name="author" onkeyup="validateAuthor()" class="form-control @error('author') is-invalid @enderror" autofocus value="{{ old('author') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="Enter publisher" id="publisher-val" name="publisher" onkeyup="validatePublisher()" class="form-control @error('publisher') is-invalid @enderror" autofocus value="{{ old('publisher') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="Enter year" id="year-val" name="year" onkeyup="validateYear()" class="form-control @error('year') is-invalid @enderror" autofocus value="{{ old('year') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="Enter pages" id="pages-val" name="pages" onkeyup="validatePages()" class="form-control @error('pages') is-invalid @enderror" autofocus value="{{ old('pages') }}">
