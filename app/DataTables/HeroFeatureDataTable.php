...
class HeroFeatureDataTable extends DataTable
{
    /**
     ...
     */
    public function query(HeroFeature $model): QueryBuilder
    {
    ...
    {
        return 'HeroFeature_' . date('YmdHis');
    }
}
