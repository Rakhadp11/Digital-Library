...
class ExploreFeatureDataTable extends DataTable
{
    /**
     ...
     */
    public function query(ExploreFeature $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('explore-feature-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('card_title')->title(__('Card Title'))->addClass('dt-center align-text-top'),
            Column::make('card_deskripsi')->title(__('Card Deskripsi'))->addClass('dt-center align-text-top'),
    ...
    {
        return 'ExploreFeature_' . date('YmdHis');
    }
}
